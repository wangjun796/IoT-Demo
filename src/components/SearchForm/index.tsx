...
import {Input, DatePicker, InputNumber, Form, Row, Col, Button, Icon, Select, TreeSelect,Divider} from "antd";
    ...
    return (
        <Form
            ...
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
                {(expand ? formItems.slice(0, 2) : formItems).map((item,index) => (
                    <Col
                        style={{ height: 56 }}
                        md={9}
                        sm={24}
                    ...
                    >
                        ...
                        {(index%2==0)&&<Divider type="vertical" />}
                    </Col>
                ))}
                <div
                    style={{
