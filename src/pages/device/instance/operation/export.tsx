...
const Export: React.FC<Props> = props => {
  ...
  const downloadTemplate = () => {
    ...
    if (product) {
      formElement.action = `/${globalConfig.apiPrefix}/device/instance/${product}/export.${fileType}`;
    } else {
      formElement.action = `/${globalConfig.apiPrefix}//device/instance/export.${fileType}`;
    }
